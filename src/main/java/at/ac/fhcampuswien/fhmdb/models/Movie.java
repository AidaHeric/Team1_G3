...
// Represents a movie with its title, description and genres
...
public class Movie implements Comparable<Movie>{
    ...
    public Movie(String title, String description, List<String> genres) { // Constructs a movie object with specifications
        this.title = title; // Title of the movie
        this.description = description; // Description of the movie
        this.genres = genres; // Genre of the movie
    }
    ...
    public static List<String> getAllGenres() {
        return Arrays.asList("ALL","ACTION", "ADVENTURE", "ANIMATION", "BIOGRAPHY", "COMEDY",
                ...
                "WESTERN"); // Returns a list of all available genres
    }
